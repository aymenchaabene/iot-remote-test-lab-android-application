...
import tn.esprit.mhaf.Adapters.DataGroupAdapter;
import tn.esprit.mhaf.utils.Constants;
import tn.esprit.mhaf.Models.DataGroup;
import tn.esprit.mhaf.R;

public class DataGroupActivity extends AppCompatActivity {
    ...
    private void loadDataGroup() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_DataGroupList,
                response -> {
                    try {
                        /*
                        *     JSONArray datatype =  datagroup.getJSONArray("datatypes");
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            dataGroupList.add(new DataGroup(

                                    datagroup.getString("name"),
                                    datagroup.getString("description"),
                                    datagroup.getString("action"),
                                    daatt.getString("data_type_name")
                        ...
                        DataGroupAdapter adapter = new DataGroupAdapter(DataGroupActivity.this, dataGroupList);
    ...
    private void runAnimation(RecyclerView recyclerView , int type)
    {
        ...
        DataGroupAdapter adapter = new DataGroupAdapter(context,dataGroupList);
        recyclerView.setAdapter(adapter);
